...
public class SSD1_AREA_INDUSTRY implements Serializable {
	private String SID;
	private String SRC_SEQ_NUM;
	private String ENTNAME;   
	private String provinceName;
	private String cityName;
	private String hyzlmc;
	private String hymx;
	...
	public String getHyzlmc() {
		return hyzlmc;
	}
	public void setHyzlmc(String hyzlmc) {
		this.hyzlmc = hyzlmc;
	}
	...
	public String toString() {
		return SID + "|+|" + SRC_SEQ_NUM +"|+|"  + ENTNAME
				+  "|+|"+ provinceName + "|+|" + cityName +"|+|"  + hyzlmc +  "|+|"+ hymx
				+  "|+|"+ QUERY_SYS + "|+|" + OPDATE ;
	}
